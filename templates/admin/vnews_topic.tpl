        ...
        <tr class="odd" id="mod_<{$topic.topic_id}>">
            ...
            <td class="txtcenter width5 bold">
                <img class="cursorpointer" id="topic_online<{$topic.topic_id}>"
                     onclick="vnews_setOnline( { op: 'topic_online', topic_id: <{$topic.topic_id}> }, 'topic_online<{$topic.topic_id}>', 'backend.php' )"
            ...
            <td class="txtcenter width5 bold">
                <img class="cursorpointer" id="topic_asmenu<{$topic.topic_id}>"
                     onclick="vnews_setAsmenu( { op: 'topic_asmenu', topic_id: <{$topic.topic_id}> }, 'topic_asmenu<{$topic.topic_id}>', 'backend.php' )"
            ...
            <td class="txtcenter width5 bold">
                <img class="cursorpointer" id="topic_show<{$topic.topic_id}>"
                     onclick="vnews_setShow( { op: 'topic_show', topic_id: <{$topic.topic_id}> }, 'topic_show<{$topic.topic_id}>', 'backend.php' )"
...
<{foreach item=topic from=$topics}>
    <div id="dialog<{$topic.topic_id}>" title="<{$topic.topic_title}>" style='display:none;'>
        <div class="marg5 pad5 ui-state-default ui-corner-all">
            <{$smarty.const._VNEWS_AM_TOPIC_NAME}> : <span
                    class="bold"> <{if $topic.contentcount == 0}><{$topic.topic_title}><{else}><a
                    href="article.php?topic=<{$topic.topic_id}>"><{$topic.topic_title}></a><{/if}></span>
        </div>
        <div class="marg5 pad5 ui-state-highlight ui-corner-all">
            <div class="pad5"><span class="bold"><{$smarty.const._VNEWS_AM_TOPIC_DESC}> : </span><img
            ...
            <div class="pad5"><span class="bold"><{$smarty.const._VNEWS_AM_TOPIC_WEIGHT}>
                    : </span><{$topic.topic_weight}></div>
            <div class="pad5"><span class="bold"><{$smarty.const._VNEWS_AM_TOPIC_PERPAGE}>
                    : </span><{$topic.topic_perpage}></div>
            <div class="pad5"><span class="bold"><{$smarty.const._VNEWS_AM_TOPIC_COLUMNS}>
