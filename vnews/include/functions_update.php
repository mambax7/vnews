...
function xoops_module_update_news($module, $version) {
    ...
    $db = $GLOBALS["xoopsDB"];
     ...
     include_once XOOPS_ROOT_PATH . '/modules/vnews/include/functions.php';
     include_once XOOPS_ROOT_PATH . '/modules/vnews/class/perm.php';
     include_once XOOPS_ROOT_PATH . '/modules/vnews/class/utils.php';
