<{if $block.show == 'vnews'}>
    <div class="itemBlock">
        <{foreach item=content from=$block.contents}>
            <div class="item">
                <div class="itemHead">
                    <div class="itemTitle"><h3><{if $content.story_important}><span
                                    class="red bold"><{$smarty.const._VNEWS_MB_IMPORTANT}></span><{/if}><a
                                    title="<{$content.title}>"
                ...
                <{foreach item=content from=$block.contents}>
                    ...
                    <li>
                        <h3><{if $content.story_important}><span
                                    class="red bold"><{$smarty.const._VNEWS_MB_IMPORTANT}></span><{/if}><a
                                    href="<{$content.url}>"
                                    title="<{$content.story_title}>"><{$content.story_title}></a>
                        </h3>
                        <{if $block.date}>
                ...
                <{foreach item=content from=$block.contents}>
                    <li>
                        <{if $content.story_important}><span
                                class="red bold"><{$smarty.const._VNEWS_MB_IMPORTANT}></span><{/if}><a
                                href="<{$content.url}>"
                                title="<{$content.story_title}>"><{$content.title}></a>
                        <{if $block.date}>
                            ...
                            <div class="itemBody" id="story_<{$content.story_id}>">
                                ...
                                <{if $block.description}>
                                    ...
                                    <div class="itemMore"><a title="<{$content.title}>"
                                                             href="<{$content.url}>"><{$smarty.const._VNEWS_MB_MORE}></a>
                                    </div>
                                <{/if}>
                                <div class="clear"></div>
                            </div>
            ...
            <{if $content.story_id != $block.spotlightid}>
                <div class="itemBlockRight">
                    <h3><{if $content.story_important}><span
                                class="red bold"><{$smarty.const._VNEWS_MB_IMPORTANT}></span><{/if}><a
                                href="<{$content.url}>"
                                title="<{$content.story_title}>"><{$content.story_title|truncate:80}></a>
                    </h3>
                </div>
            <{/if}>
        <{/foreach}>
