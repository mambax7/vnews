...
class VnewsUtils {
    ...
    public static function News_UtilityUploadImg($type, $obj, $image) {
        ...
        $pach_original = XOOPS_ROOT_PATH . xoops_getModuleOption ( 'img_dir', 'vnews') . '/original/';
        $pach_medium = XOOPS_ROOT_PATH . xoops_getModuleOption ( 'img_dir', 'vnews') . '/medium/';
        $pach_thumb = XOOPS_ROOT_PATH . xoops_getModuleOption ( 'img_dir', 'vnews') . '/thumb/';
     ...
     */
    public static function News_UtilityBreadcrumb( $lasturl, $breadcrumbtitle, $topic_id, $prefix = ' &raquo; ', $title = 'topic_title') {
        $breadcrumb = '';
        include_once XOOPS_ROOT_PATH . '/modules/vnews/class/topic.php';
    ...
    public static function News_UtilityHomePage( $story_infos, $type) {
        ...
        switch ($type) {
            ...
            // List all topics
            case 'type2' :
                 $topic_order = xoops_getModuleOption('admin_showorder_topic', 'vnews');
              $topic_sort = xoops_getModuleOption('admin_showsort_topic', 'vnews');
            ...
            case 'type4' :
                   if ($story_infos['id'] && $story_infos['title'] && $story_infos['alias']) {
                    ...
                    $id = 0;
                    $title = xoops_getModuleOption ( 'static_name', 'vnews');
                    $alias = self::News_UtilityAliasFilter(xoops_getModuleOption('static_name', 'vnews'));
                   }
   ...
   /**
    ...
    public static function News_UtilityTopicUrl($array) {
        $lenght_id = xoops_getModuleOption('lenght_id', 'vnews');
        $friendly_url = xoops_getModuleOption('friendly_url', 'vnews');
        if ($lenght_id != 0) {
            $id = $array['topic_id'];
        ...
        switch ($friendly_url) {
            ...
            case 'rewrite':
                $rewrite_base = xoops_getModuleOption('rewrite_mode', 'vnews');
                $rewrite_ext = xoops_getModuleOption('rewrite_ext', 'vnews');
                $module_name = '';
                if (xoops_getModuleOption('rewrite_name', 'vnews')) {
                    $module_name = xoops_getModuleOption('rewrite_name', 'vnews') . '/';
                }
                $page = $array['topic_alias'];
                $type = xoops_getModuleOption('topic_name', 'vnews') . '/';
                $id = $id . '/';
   ...
   /**
    ...
    public static function News_UtilityStoryUrl($array , $type = 'article') {
        ...
        if (isset($array['topic_alias']) && $array['topic_alias']) {
            ...
            $topic_name = self::News_UtilityAliasFilter(xoops_getModuleOption('static_name', 'vnews'));
        }
