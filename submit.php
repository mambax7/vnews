...
global $xoopsUser;
if (! $perm_handler->News_PermissionIsAllowed ( $xoopsUser, 'vnews_ac', '8')) {
...
switch ($op) {
    case 'add' :
        ...
        if ($perm_handler->News_PermissionIsAllowed ( $xoopsUser, 'vnews_ac', '16')) {
        ...
        if ((xoops_getModuleOption ( 'usetag', 'vnews' )) and (is_dir ( XOOPS_ROOT_PATH . '/modules/tag' ))) {
            ...
            $tag_handler->updateByItem ( $_POST ["item_tag"], $obj->getVar ( 'story_id' ), 'vnews', 0 );
        }
