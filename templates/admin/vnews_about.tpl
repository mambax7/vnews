    ...
    <div class="floatleft width50">
        <fieldset>
            ...
            <div class="floatright width75 line140 marg5 pad5">
                ...
                <div class="line140 marg2 pad2"><span
                            class="bold"><{$smarty.const._VNEWS_AM_ABOUT_AUTHOR}></span> <{$module_author}></div>
                <div class="line140 marg2 pad2"><span
                            class="bold"><{$smarty.const._VNEWS_AM_ABOUT_CREDITS}></span> <{$module_credits}></div>
                <div class="line140 marg2 pad2"><span class="bold"><{$smarty.const._VNEWS_AM_ABOUT_LICENSE}></span> <a
        ...
        <fieldset>
            ...
            <div class="aboutposition">
                <div class="line140 marg2 pad2"><span
                            class="bold"><{$smarty.const._VNEWS_AM_ABOUT_DESCRIPTION}></span> <{$module_description}>
                </div>
                <div class="line140 marg2 pad2"><span
                            class="bold"><{$smarty.const._VNEWS_AM_ABOUT_RELEASEDATE}></span> <{$module_release_date}>
                </div>
                <div class="line140 marg2 pad2"><span
                            class="bold"><{$smarty.const._VNEWS_AM_ABOUT_UPDATEDATE}></span> <{$module_last_update}>
                </div>
                <div class="line140 marg2 pad2"><span
                            class="bold"><{$smarty.const._VNEWS_AM_ABOUT_MODULE_STATUS}></span> <{$module_status}></div>
                <div class="line140 marg2 pad2">
