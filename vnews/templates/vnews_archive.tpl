<div class="vnews-archive">
   <div class="pad2 marg2">
	...
	<div class="marg2 pad2 center"><a title="<{$smarty.const._VNEWS_MD_ARCHIVE_TOTAL}>" href="<{$xoops_url}>/modules/<{$module}>/archive.php"><{$smarty.const._VNEWS_MD_ARCHIVE_TOTAL}></a></div>
	<{/if}>
