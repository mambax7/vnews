...
<table id="xo-file-sort" class="outer" cellspacing="1" width="100%">
    <thead>
    <th><{$smarty.const._VNEWS_AM_FILE_ID}></th>
    <th><{$smarty.const._VNEWS_AM_FILE_TITLE}></th>
    <th><{$smarty.const._VNEWS_AM_FILE_CONTENT}></th>
    <th><{$smarty.const._VNEWS_AM_FILE_TYPE}></th>
    <th><{$smarty.const._VNEWS_AM_FILE_ONLINE}></th>
    <th><{$smarty.const._VNEWS_AM_FILE_ACTION}></th>
    </thead>
    <tbody class="xo-file">
