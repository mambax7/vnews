...
class FolderHandler
{
     ...
     * @param $path
     *
     * @internal param string $desired_path Path to the directory to change to
     ...
     * @param bool   $sort
     *
     * @internal param string $pattern Preg_match pattern (Defaults to: .*)
     ...
     * @access   private
     */
    public function tree($path, $hidden)
    {
        if (is_dir($path)) {
     ...
     *
     * @internal param string $directory Path to directory
     *
     * @return int
     * @access   public
     */
