...
$xoopsTpl->xoops_setCacheTime(xoops_getModuleOption('rss_timecache', 'vnews') * 1);
...
if (!$xoopsTpl->is_cached('db:vnews_rss.tpl')) {
    ...
    $xoopsTpl->assign('image_url', XOOPS_URL . xoops_getModuleOption('rss_logo', 'vnews'));
    $dimention = getimagesize(XOOPS_ROOT_PATH . xoops_getModuleOption('rss_logo', 'vnews'));
    ...
    $story_infos = array(
        ...
        'story_limit' => xoops_getModuleOption('rss_perpage', 'vnews'),
