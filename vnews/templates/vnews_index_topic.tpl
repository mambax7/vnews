<div class="vnews-index-topic">
	<div class="vnews-topicinfo">
	...
	<div class="subTopicList">
		<h4><{$smarty.const._VNEWS_MD_SUBTOPICS}></h4>
		<ul>
			<{foreach item=topic from=$sub_topic}>
			<li class="width33 floatleft"><a title="<{$topic.topic_title}>" href="<{$topic.topic_url}>"><{$topic.topic_title}></a></li>
			<{/foreach}>
		</ul>
		<div class="clear"></div>
	</div>
