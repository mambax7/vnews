...
switch ($op) {
    ...
    case 'alias':
        ...
        VnewsUtils::News_UtilityRebuild ($story_handler , 'story_id' , 'alias' , 'story_alias' , 'story_title' , $start_id , $end_id);
    ...
    case 'topicalias':
        $start_id = VnewsUtils::News_UtilityCleanVars($_REQUEST, 'start_id', '1', 'int');
        $end_id = VnewsUtils::News_UtilityCleanVars($_REQUEST, 'end_id', '1', 'int');
        VnewsUtils::News_UtilityRebuild ($topic_handler , 'topic_id' , 'topicalias' , 'topic_alias' , 'topic_title' , $start_id , $end_id);
        VnewsUtils::News_UtilityRedirect('tools.php', 1, _VNEWS_AM_MSG_WAIT);
         break;
    ...
    case 'keyword':
        $start_id = VnewsUtils::News_UtilityCleanVars($_REQUEST, 'start_id', '1', 'int');
        $end_id = VnewsUtils::News_UtilityCleanVars($_REQUEST, 'end_id', '1', 'int');
        VnewsUtils::News_UtilityRebuild ($story_handler , 'story_id' , 'keyword' , 'story_words' , 'story_title' , $start_id , $end_id);
        VnewsUtils::News_UtilityRedirect('tools.php', 1, _VNEWS_AM_MSG_WAIT);
         break;
    ...
    case 'description':
        $start_id = VnewsUtils::News_UtilityCleanVars($_REQUEST, 'start_id', '1', 'int');
        $end_id = VnewsUtils::News_UtilityCleanVars($_REQUEST, 'end_id', '1', 'int');
        VnewsUtils::News_UtilityRebuild ($story_handler , 'story_id' , 'description' , 'story_desc' , 'story_title' , $start_id , $end_id);
        VnewsUtils::News_UtilityRedirect('tools.php', 1, _VNEWS_AM_MSG_WAIT);
         break;
...
// Call template file
$xoopsTpl->display(XOOPS_ROOT_PATH . '/modules/vnews/templates/admin/vnews_tools.tpl');
