...
<div id="xo-print">
    <div id="xo-print-content">
        <{if $print_logo}><div class="<{$print_logofloat}> spacer"><img src="<{$print_logourl}>" alt="<{$xoops_sitename}>" /></div><{/if}>
        <div class="item">
            ...
            <div class="itemBody <{$print_columns}>">
                 <{if $print_img && $content.img}>
		            <div class="itemImg">
			            <img width="<{$imgwidth}>" class="<{$imgfloat}> story_img" src="<{$content.thumburl}>" alt="<{$content.title}>"/>
		            </div>
                <{/if}>
